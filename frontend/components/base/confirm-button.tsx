import { Button, Popover, PopoverContent, PopoverProps, PopoverTrigger, Tooltip, TooltipProps } from "@nextui-org/react"
...
// const OptionalTooltip = ({ tooltip, children, tooltipProps }: OptionalTooltipProps) => {
//   return tooltip
...
const PopTooltip = ({ trigger, tooltip, isOpen, setIsOpen, children, popoverProps, tooltipProps, className }: PopTooltipProps) => {
  return (
    <Popover isOpen={isOpen} onOpenChange={setIsOpen} {...popoverProps}>
      {
        tooltip
          ? <Tooltip content={tooltip} {...tooltipProps}>
